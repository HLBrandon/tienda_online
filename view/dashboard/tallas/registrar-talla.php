...
<form enctype="multipart/form-data" class="row g-3 d-flex align-items-center" method="post" autocomplete="off" id="formulario">
    <div class="col-sm-6">
        ...
        <input class="form-control form-control-lg rounded-0 border-3" type="text" name="talla" id="talla" placeholder="Talla...">
    </div>
    <div class="mb-5">
        <button class="btn btn-lg btn-success rounded-0 border-3 text-uppercase" type="submit">Registrar Talla</button>
...
<script>
    $(document).ready(function() {
        $("#formulario").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= URL_RAIZ ?>php/controladores-admin/tallas/control_registrar_talla.php",
                data: formulario,
                contentType: false,
                processData: false,
