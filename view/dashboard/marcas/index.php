...
<a class="btn btn-lg btn-primary rounded-0" href="<?= URL_RAIZ ?>view/dashboard/marcas/registrar-marca.php"><i class="bi bi-plus-circle me-2"></i>Nuevo</a>
...
<div class="table-responsive mt-2 mb-5">
    <table class="table table-striped shadow" id="tabla-marca">
        ...
        <tbody id="cuerpo_tabla_cliente" class="bg-white">
            ...
            while ($row = $resultado->fetch_object()) : ?>
                <tr>
                    <td class="text-center"><?= $row->marca_id ?></td>
